   ...
   <div className={style.overviewContainer}>
    ...
    <ul className={style.overAmounts}>
      <li className={style.overAmountsItem}>
        ...
        <p className={style.currentBalance}>${data && data.balance.current}.00</p>
      </li>
      <li className={style.overAmountsItem}>
        <p className={style.currentBalanceTitle}>Income</p>
        <p className={style.currentBalance}>${data && data.balance.income}</p>
      </li>
      <li className={style.overAmountsItem}>
        <p className={style.currentBalanceTitle}>Expenses</p>
        <p className={style.currentBalance}>${data && data.balance.expenses
        }</p>
      </li>
    </ul>
    ...
    <div className={style.overAllInfos}>
      ...
      <div className={style.pots}>
        ...
        <p className={style.viewPots}>See Details <FaCaretRight /></p>
        </NavLink>
        </div>
